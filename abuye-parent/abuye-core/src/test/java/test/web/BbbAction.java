...
@ControllerMappingAnnotation("/bbb")
public class BbbAction {
  private static final Logger log = LoggerFactory.getLogger(BbbAction.class);
  static{
    ControllerMappingCache.addControllerClass(BbbAction.class);
  }
